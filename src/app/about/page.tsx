      ...
      {loading ? (
        ...
        <>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-[-20rem] max-sm:bottom-[-16.3rem] max-md:bottom-[-16.5rem] max-xl:bottom-[-19rem] max-2xl:bottom-[-19.5rem] right-0 left-0">
              <NavBar tab="ABOUT" />
          ...
          <div className="flex flex-row justify-between gap-16 mt-56  mx-auto w-[70%] max-sm:gap-5 max-sm:w-[80%] max-md:w-[90%]">
            ...
            <div className="flex-1 flex flex-col gap-12 max-sm:gap-2 max-xl:gap-5 max-2xl:gap-8">
              <div className="flex flex-row justify-between max-sm:gap-2">
                ...
                <p className="w-[80%] text-[16px] leading-10 max-sm:text-[4px] max-sm:leading-[0.85rem] max-md:text-[8px] max-md:leading-5 max-xl:text-[11px] max-xl:leading-8 max-2xl:text-[13px] max-2xl:leading-8">
              ...
              <div className="flex flex-row justify-between max-sm:gap-5">
                ...
                <p className="w-[80%] text-[16px] leading-10 max-sm:text-[4px] max-sm:leading-[0.85rem] max-md:text-[8px] max-md:leading-5 max-xl:text-[11.5px] max-xl:leading-8  max-2xl:text-[13px] max-2xl:leading-8">
          ...
          <div className="w-[70%] mt-[10.5rem] grid grid-cols-6 mx-auto max-2xl:gap-5 max-sm:grid-cols-4">
