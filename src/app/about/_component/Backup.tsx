...
function BakcUp() {
  return (
    <div className="ml-40 mr-40">
      <div className="relative w-screen border border-[#ffcc00] items-center mx-auto">
        <div className="relative h-[900px] border border-white">
          <Image fill src="/assets/images/about1.png" alt="소개1" />
        </div>
      ...
      <div className="flex flex-col">
        ...
        <div className=" flex flex-row mt-60">
          <div className="border flex-grow">
            <div className="border-b  text-center">
              <p className="font-bold text-[35px]">
                <span className="text-[35px] font-bold">02</span> 합리적인 견적
              </p>
            </div>
            <div className="text-headline1 text-center font-medium mt-36">
        ...
        <div className="border flex flex-row mt-60">
          <div className="border flex-grow">
            <div className="border-b  text-center">
              <p className="font-bold text-[35px]">
                <span className="text-[35px] font-bold">04</span> 적극적인 제안
              </p>
            </div>
            <div className="text-headline1 text-center font-medium mt-36">
