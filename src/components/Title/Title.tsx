  ...
  return (
    <div className="flex flex-row justify-center cursor-pointer">
      ...
      <div className="flex flex-col items-center">
        <p className="text-[40px] font-bold mb-2 max-sm:text-headline3 max-md:text-[25px] max-md:mb-0 max-xl:text-[35px] max-2xl:text-[35px]">
          {title}
        </p>
        <p className="text-[40px] font-bold max-sm:text-headline3 max-md:text-[25px]  max-xl:text-[35px] max-2xl:text-[35px]">
          {content}
        </p>
      </div>
